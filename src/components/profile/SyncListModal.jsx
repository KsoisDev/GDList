...
import { fetchAredlProfile, computeSyncPlan, runAredlSync, describeSyncError } from '../../services/syncAredl'
  ...
  const handleSync = async () => {
    ...
    try {
      const result = await runAredlSync({
        userId,
        aredlProfile: profile,
        existingCompletions,
        syncStamp: {
          discordId: selectedUser?.id || profile.id || '',
            ...
            {discordUser ? (
              <div className={styles.profilePreview}>
                <div className={styles.profileHeader}>
                  {aredlAvatar(discordUser) && (
                    <img src={aredlAvatar(discordUser)} alt="" className={styles.profileAvatar} />
                  )}
                ...
                <div className={styles.syncActions}>
                  <Button variant="ghost" size="sm" onClick={handleLogoutDiscord}>
                  ...
                  <Button
                    ...
                    size="sm"
                    icon={RefreshCw}
                    onClick={() => loadAredlProfile(discordUser.id, discordUser)}
